...
public interface CppPrecompilerIf extends PsiElement {
  ...
  @NotNull
  List<CppPrecompilerElif> getPrecompilerElifList();

  @Nullable
  CppPrecompilerElse getPrecompilerElse();
