...
public class CppStringImpl extends ASTWrapperPsiElement implements CppString {

  public CppStringImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CppVarName> getVarNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CppVarName.class);
  }
