...
public class CppClassConstructorDefImpl extends ASTWrapperPsiElement implements CppClassConstructorDef {

  public CppClassConstructorDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CppVisitor visitor) {
    visitor.visitClassConstructorDef(this);
  }
  ...
  @Override
  @Nullable
  public CppMethodArgs getMethodArgs() {
    return findChildByClass(CppMethodArgs.class);
  }
