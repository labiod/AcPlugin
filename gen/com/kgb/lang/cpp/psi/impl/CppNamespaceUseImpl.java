...
public class CppNamespaceUseImpl extends ASTWrapperPsiElement implements CppNamespaceUse {

  public CppNamespaceUseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CppVisitor visitor) {
    visitor.visitNamespaceUse(this);
  }
