...
public class CppPrecompilerIfImpl extends ASTWrapperPsiElement implements CppPrecompilerIf {

  public CppPrecompilerIfImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CppVisitor visitor) {
    visitor.visitPrecompilerIf(this);
  }
  ...
  @Override
  @NotNull
  public List<CppPrecompilerElif> getPrecompilerElifList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CppPrecompilerElif.class);
  }

  @Override
  @Nullable
  public CppPrecompilerElse getPrecompilerElse() {
    return findChildByClass(CppPrecompilerElse.class);
  }
