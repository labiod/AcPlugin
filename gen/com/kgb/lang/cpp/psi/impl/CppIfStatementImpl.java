...
public class CppIfStatementImpl extends ASTWrapperPsiElement implements CppIfStatement {

  public CppIfStatementImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public CppCond getCond() {
    return findNotNullChildByClass(CppCond.class);
  }
