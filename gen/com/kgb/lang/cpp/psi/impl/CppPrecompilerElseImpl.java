...
public class CppPrecompilerElseImpl extends ASTWrapperPsiElement implements CppPrecompilerElse {

  public CppPrecompilerElseImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CppVisitor visitor) {
    visitor.visitPrecompilerElse(this);
  }
