...
public class CppClassDestructorDefImpl extends ASTWrapperPsiElement implements CppClassDestructorDef {

  public CppClassDestructorDefImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CppVisitor visitor) {
    visitor.visitClassDestructorDef(this);
  }
